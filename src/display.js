...
function renderTasks(project, filter = null) {
  ...
  if (filter === "all") projectName.textContent = "All Tasks";
  else if (filter === "today") projectName.textContent = "Today";
  else if (filter === "week") projectName.textContent = "This Week";
  else projectName.textContent = project.name;
  ...
  if (filter === "all") {
    logic.projects.forEach((p) => {
      tasksToRender.push(...p.tasks);
    });
...
allTasks.addEventListener("click", () => renderTasks(null, "all"));
today.addEventListener("click", () => renderTasks(null, "today"));
thisWeeK.addEventListener("click", () => renderTasks(null, "week"));
